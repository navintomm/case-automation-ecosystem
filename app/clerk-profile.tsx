  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Clerk Profile</Text>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Animated.View entering={FadeInDown.delay(100)} style={styles.profileCard}>
          ...
          <Text style={styles.name}>Anitha Krishnan</Text>
          <Text style={styles.email}>anitha@case.law</Text>
          
          <View style={styles.badge}>
            <Text style={styles.badgeText}>Filing Clerk</Text>
          </View>
        </Animated.View>
        ...
        <Text style={styles.version}>Project CASE Clerk Portal v1.0.0</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
